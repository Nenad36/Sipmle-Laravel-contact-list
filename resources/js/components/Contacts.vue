    ...
    <div>
        ...
        <ul class="list-group">
            <li class="list-group-item" v-for="contact in list">
                ...
                <button @click="deleteContact(contact.id)" class="btn btn-danger btn-sm float-right">Delete</button>
                <button @click="showContact(contact.id)" class="btn btn-secondary btn-sm float-right">Edit</button>
            </li>
        </ul>
    </div>
</template>
